...
/**
 * Integrations: which external systems this workspace has wired up.
 * Credentials are workspace-scoped, never shared across tenants.
 */

const PROVIDER_HINTS: Record<string, string> = {
  slack: '{"webhook_url": "https://hooks.slack.com/services/T.../B.../..."}',
  servicenow:
    '{"instance_url":"https://acme.service-now.com","user":"soar-bot","password":"...","table":"sn_si_incident"}',
  okta: '{"org_url":"https://acme.okta.com","api_token":"00..."}',
  crowdstrike: '{"cloud":"us-1","client_id":"...","client_secret":"..."}',
  cloudflare: '{"api_token":"...","zone_id":"..."}',
  webhook:
    '{"url":"https://example.com/soar","secret_header":"X-SOAR-Auth","secret_value":"..."}',
};
          ...
          <form action={add} className="space-y-4">
            <div className="grid sm:grid-cols-[200px_1fr] gap-3">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="label"
                  name="label"
                  placeholder="Acme Bank — Slack #soc-alerts"
                  required
                />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <textarea
                ...
                required
                rows={4}
                placeholder={PROVIDER_HINTS.slack}
              ...
              <p className="text-xs text-muted-foreground">
                ...
                <code>{PROVIDER_HINTS.slack}</code>,{' '}
                <code>{PROVIDER_HINTS.okta}</code>
              </p>
            </div>
