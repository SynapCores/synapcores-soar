...
export default async function ActionsLedgerPage() {
  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl space-y-6">
      <AppPageHeader
        title="Actions"
        description="Every external action the SOAR system has dispatched — by analysts, agents, and approved HBR flows."
      />
      <DataTable
        rows={result.rows}
        rowKey={(r) => r.id}
        emptyState="No actions yet. Dispatch one from an alert or wire your first integration at /settings/integrations."
        columns={[
          {
            key: 'requested_at',
            header: 'When',
