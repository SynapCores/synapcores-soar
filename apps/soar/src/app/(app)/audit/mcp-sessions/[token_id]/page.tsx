...
export default async function McpSessionDetailPage({
  ...
  return (
    <div className="p-6 md:p-8 max-w-6xl space-y-6">
      <AppPageHeader
        title={`Auditor session: ${token.label}`}
        description={`${calls.rowCount} tool call${calls.rowCount === 1 ? '' : 's'} recorded. Every action they took is on this page.`}
        actions={
      ...
      <DataTable
        ...
        emptyState="This auditor hasn't made any calls yet."
        columns={[
          {
            key: 'ts',
            header: 'When',
